...
def test_full_phrase(phrase):
    ...
    for idx, chunk in enumerate(chunks):
        # We use our fixed function here directly
        morse_parcial = processar_stream_binario_fixed(chunk, buf)
        
        # We also need to patch the buffer access in morse_stream_para_texto
        # Wait, I'll just copy morse_stream_para_texto and make it use local buf
    ...
    print("Got:     ", texto_result)

phrase = "O JOVEM MAIS FRACO SEM GRANDE EXPERIENCIA EM BATALHAS REPRESENTADO POR UM APOSTADOR DO RIO ARRISCOU QUE AO CHUTAR NUMEROS ACERTARIA JUSTAMENTE OS SORTEADOS PELA CAIXA ECONOMICA FEDERAL"
test_full_phrase(phrase)
